# MMC module - High-frequency test
...
First, the individual module test is performed in low-frequency and then in high-frequency. The figure below shows the high-frequency test sequence. The user must have a programmable DC power supply that TURN ON the udc power supply to start the sequence first part (positive current) and after 0.45 s TURN OFF udc to start the sequence second part (negative current).

<img width="1199" height="273" alt="image" src="https://github.com/user-attachments/assets/fa0df3d5-3650-4df1-b246-69c45fc65a61" />
