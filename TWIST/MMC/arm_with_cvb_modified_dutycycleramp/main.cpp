...
/**
 * @brief  This example deploys the open-loop control of a MMC arm integrating a Capacitor Voltage Balancing algorithm  modified to reduce module switching. It also uses duty cycle ramping to reduce high-frequency oscillations from low-side LC filter. 
