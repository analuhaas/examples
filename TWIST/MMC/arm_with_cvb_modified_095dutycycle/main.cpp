...
/**
 * @brief  This example deploys the open-loop control of a MMC arm integrating a Capacitor Voltage Balancing algorithm modified to reduce module switching. Also uses modified connected state duty cycle of 0.95 instead of 1. 
