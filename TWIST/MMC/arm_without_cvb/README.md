...
6.	If not done yet: Test the module using the [low-frequency](https://github.com/analuhaas/MMC/blob/tutorials_updates/MMC_documentation/module_LF_test_tutorial.md) and [high-frequency](https://github.com/analuhaas/MMC/blob/tutorials_updates/MMC_documentation/module_HF_test_tutorial.md) tests.
