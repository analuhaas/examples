# MMC module - High-frequency test (modified)
...
The difference between this test and the original high-frequency test is that the code was modified to no longer need programmable DC power supply.
