# MMC arm - with CVB using 0.95 duty cycle during connected state
...
The difference between this example and the arm CVB example is that a 0.95 duty cycle is used during connected state instead of 1. This is alternative used to maintain the bootstrap capacitor charged. The modification is in the line of code:
